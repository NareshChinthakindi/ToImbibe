...
<div id="content">
    ...
    <div id="content_right">
        ...
        <div class="content_right_280_section">
            ...
            <table>
            <tr>
               <td> Login Id : </td> <td> <input type="text" name="login"/></td>
...
<div id="footer_wrapper">        
    <div id="footer">
        Copyright © 2048 <a href="subpage.html">Your Company Name</a> | 
        <a href="http://www.templatemo.com" target="_parent">Website Templates</a> by <a href="http://www.freecsstemplates.in" target="_parent">Free CSS Templates</a>
    </div><!-- end of footer -->
